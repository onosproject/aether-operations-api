...
type DeviceGroup struct {
	...
	DevicegroupId string `protobuf:"bytes,1,opt,name=devicegroup_id,json=devicegroupId,proto3" json:"devicegroup_id,omitempty"`
...
func (x *DeviceGroup) GetDevicegroupId() string {
	if x != nil {
...
func (x *DeviceGroups) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeviceGroups) ProtoMessage() {}

func (x *DeviceGroups) ProtoReflect() protoreflect.Message {
	mi := &file_devicegroups_v1_devicegroups_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeviceGroups.ProtoReflect.Descriptor instead.
func (*DeviceGroups) Descriptor() ([]byte, []int) {
	return file_devicegroups_v1_devicegroups_proto_rawDescGZIP(), []int{1}
}

func (x *DeviceGroups) GetDeviceGroups() []*DeviceGroup {
	if x != nil {
...
var file_devicegroups_v1_devicegroups_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x75, 0x70, 0x73, 0x42, 0x40, 0x5a, 0x3e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	...
	0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x67, 0x72, 0x6f,
	0x75, 0x70, 0x73, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_devicegroups_v1_devicegroups_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_devicegroups_v1_devicegroups_proto_goTypes = []interface{}{
	(*DeviceGroup)(nil),  // 0: devicegroups.v1.DeviceGroup
	(*DeviceGroups)(nil), // 1: devicegroups.v1.DeviceGroups
}
var file_devicegroups_v1_devicegroups_proto_depIdxs = []int32{
	0, // 0: devicegroups.v1.DeviceGroups.device_groups:type_name -> devicegroups.v1.DeviceGroup
