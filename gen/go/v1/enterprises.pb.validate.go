...
// Validate checks the field values on GetEnterprisesResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetEnterprisesResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetEnterprisesResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetEnterprisesResponseMultiError, or nil if none found.
func (m *GetEnterprisesResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetEnterprisesResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetEnterprises() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GetEnterprisesResponseValidationError{
						field:  fmt.Sprintf("Enterprises[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return GetEnterprisesResponseValidationError{
					field:  fmt.Sprintf("Enterprises[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GetEnterprisesResponseMultiError(errors)
	}

	return nil
}

// GetEnterprisesResponseMultiError is an error wrapping multiple validation
// errors returned by GetEnterprisesResponse.ValidateAll() if the designated
// constraints aren't met.
type GetEnterprisesResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetEnterprisesResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetEnterprisesResponseMultiError) AllErrors() []error { return m }

// GetEnterprisesResponseValidationError is the validation error returned by
// GetEnterprisesResponse.Validate if the designated constraints aren't met.
type GetEnterprisesResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetEnterprisesResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetEnterprisesResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetEnterprisesResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetEnterprisesResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetEnterprisesResponseValidationError) ErrorName() string {
	return "GetEnterprisesResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetEnterprisesResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetEnterprisesResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetEnterprisesResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetEnterprisesResponseValidationError{}
