...
// Validate checks the field values on GetApplicationsResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetApplicationsResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetApplicationsResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetApplicationsResponseMultiError, or nil if none found.
func (m *GetApplicationsResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetApplicationsResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetApplications() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GetApplicationsResponseValidationError{
						field:  fmt.Sprintf("Applications[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return GetApplicationsResponseValidationError{
					field:  fmt.Sprintf("Applications[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GetApplicationsResponseMultiError(errors)
	}

	return nil
}

// GetApplicationsResponseMultiError is an error wrapping multiple validation
// errors returned by GetApplicationsResponse.ValidateAll() if the designated
// constraints aren't met.
type GetApplicationsResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetApplicationsResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetApplicationsResponseMultiError) AllErrors() []error { return m }

// GetApplicationsResponseValidationError is the validation error returned by
// GetApplicationsResponse.Validate if the designated constraints aren't met.
type GetApplicationsResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetApplicationsResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetApplicationsResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetApplicationsResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetApplicationsResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetApplicationsResponseValidationError) ErrorName() string {
	return "GetApplicationsResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetApplicationsResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetApplicationsResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetApplicationsResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetApplicationsResponseValidationError{}
