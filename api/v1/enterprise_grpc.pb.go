...
type EnterpriseServiceClient interface {
	GetEnterprises(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Enterprises, error)
}
...
func (c *enterpriseServiceClient) GetEnterprises(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Enterprises, error) {
	out := new(Enterprises)
	err := c.cc.Invoke(ctx, "/enterprise.EnterpriseService/GetEnterprises", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EnterpriseServiceServer interface {
	GetEnterprises(context.Context, *emptypb.Empty) (*Enterprises, error)
...
func (UnimplementedEnterpriseServiceServer) GetEnterprises(context.Context, *emptypb.Empty) (*Enterprises, error) {
...
func _EnterpriseService_GetEnterprises_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/enterprise.EnterpriseService/GetEnterprises",
	}
...
var EnterpriseService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/v1/enterprise.proto",
}
